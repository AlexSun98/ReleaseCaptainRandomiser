...
*/
export const getBooksState = createFeatureSelector('books');
/**
 ...
 */
export const getSearchState = createSelector(getBooksState, (state) => state.search);
...
export const getCollectionState = createSelector(getBooksState, (state) => state.collection);
